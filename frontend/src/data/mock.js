...
export const personalInfo = {
  ...
  bio: [
    "Breaking Code Early So Users Never Do — I am a Software Development Engineer in Test with over five years of experience building reliable, scalable test automation for web, API, and data-driven systems. I enjoy turning complex testing problems into clean, efficient solutions that help teams ship faster with confidence.",
    "My career started at Cognizant, where I saw firsthand how the right automation strategy can transform quality engineering. By identifying high-impact test scenarios and applying logic-based automation, I helped reduce a manual testing effort of 80 days down to just 5. That experience shaped my approach to quality with a strong focus on efficiency, maintainability, and real business impact. I currently work as a QA Automation Engineer at Community Dream Foundation, where I design and maintain automation frameworks across functional, regression, UI, and API testing while collaborating closely with developers and stakeholders in an agile environment.",
    "I hold a Master's degree in Analytics from Northeastern University with a specialization in Applied Machine Intelligence, which allows me to bring a data-driven mindset to testing, especially for APIs, data pipelines, and backend systems. Outside of my day-to-day work, I enjoy mentoring junior engineers, exploring new testing tools, and learning how AI and analytics can improve software quality. I care deeply about building products that work well, scale well, and earn user trust."
  ],
  contact: {
